    ...
    if image_file is not None:
        ...
        if st.button("Analyze Prescription"):
            ...
            user_prompt = (
                ...
                "{extracted_text} at next line mention and Give the approximate price range (for generic medicine within 50INR if available like Rs(30-35)Rs(30-45)Rs(25-30)Rs(25-35)(20-30))"
            response_text = gemini_pro_response(user_prompt)
            st.session_state['chat_history'].append({"user": extracted_text, "response": response_text})
